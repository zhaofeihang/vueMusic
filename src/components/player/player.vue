<template>
  <div class="player" v-show="playList.length>0">
          ...
          <div class="middle-l" ref="middleL">
            <div class="cd-wrapper" ref="cdWrapper">
              <div class="cd" ref="imageWrapper">
                <img ref="image" :class="cdClass" class="image" :src="currentSong.image">
              </div>
            </div>
      ...
      <div class="mini-player" v-show="!fullScreen" @click="open">
        <div class="icon">
          <div class="imgWrapper" ref="miniWrapper">
            <img ref="miniImage" :class="cdClass" width="40" height="40" :src="currentSong.image">
          </div>
        </div>
        <div class="text">
    ...
    <audio @ended="end" @timeupdate="updateTime" @playing="ready" @error="error" ref="audio"
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      afterEnter() {
        animations.unregisterAnimation(name, 'move')
